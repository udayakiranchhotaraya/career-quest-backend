...
// Route to delete specific education entry from user profile, protected by JWT token, calls deleteEducation controller
UserRouter.delete('/profile/education/:educationId/delete', verifyToken, deleteEducation);
